...
khaleel = Player.create_with_rating_and_group(name: "Khaleel Asgarali", email: "asgarali.wdctt@gmail.com", rating: 2500, group_id: nil, admin: false, username: "khaleel", password: "khaleelpw1234")
...
john = Player.create_with_rating_and_group(name: "John Harrison", email: "harrison.john@plsystems.net", rating: 1128, group_id: tuesday_group.id, admin: false, username: "john", password: "johnpw1234")
ben = Player.create_with_rating_and_group(name: "Ben Nix", email: "marlanix@hotmail.com", rating: 800, group_id: tuesday_group.id, admin: false, username: "ben", password: "benpw1234")
moses = Player.create_with_rating_and_group(name: "Moses Kitakule", email: "moseskitakule@gmail.com", rating: 902, group_id: tuesday_group.id, admin: false, username: "moses", password: "mosespw1234")
ted = Player.create_with_rating_and_group(name: "Ted Udelson", email: "tedU@IntegrityComputing.com", rating: 1052, group_id: tuesday_group.id, admin: false, username: "ted", password: "tedpw1234")
zack = Player.create_with_rating_and_group(name: "Zack Lessner", email: "lessnerzachary@gmail.com", rating: 1181, group_id: tuesday_group.id, admin: false, username: "zack", password: "zackpw1234")
wondu = Player.create_with_rating_and_group(name: "Wondwosen Shiferaw", email: "wshiferaw82@gmail.com", rating: 1212, group_id: tuesday_group.id, admin: false, username: "wondu", password: "wondupw1234")
jeremie = Player.create_with_rating_and_group(name: "Jeremie Auboux", email: "jeremie.aubou@gmail.com", rating: 1238, group_id: tuesday_group.id, admin: false, username: "jeremie", password: "jeremiepw1234")
abhi = Player.create_with_rating_and_group(name: "Abhi Pabba", email: "abhipabba@yahoo.com", rating: 1428, group_id: tuesday_group.id, admin: false, username: "abhi", password: "abhipw1234")
